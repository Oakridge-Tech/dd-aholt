...
########################################
data "aws_iam_policy_document" "cloudtrail-kms-policy" {
  statement {
...
###############################################################################
#IAM Policy document to allow CloutTrail Service in any account to assume role# 
###############################################################################
...
#####################################################################
#IAM Policy document to allow CloutTrail to write logs to CloudWatch# 
#####################################################################
